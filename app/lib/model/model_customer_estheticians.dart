...
EstheticianListModel estheticianListModelFromJson(String str) =>
    EstheticianListModel.fromJson(json.decode(str));

String welcomeToJson(EstheticianListModel data) => json.encode(data.toJson());

class EstheticianListModel {
  EstheticianListModel({
    this.data,
  });

  List<Datum> data;

  factory EstheticianListModel.fromJson(Map<String, dynamic> json) =>
      EstheticianListModel(
