...
class CustomerAppointment {
  ...
  final String actual_time;
  final String sms_replied_time;
  final String reason_for_cancellation;
  ...
  factory CustomerAppointment.fromJson(Map<String, dynamic> json) {
    return CustomerAppointment(
      ...
      sms_replied_time: json['sms_replied_time'],
      reason_for_cancellation: json['reason_for_cancellation'],
    );
  }
}
