...
class CalendarScreenWeekly extends StatefulWidget {
  @override
  _CalendarScreenWeeklyState createState() => _CalendarScreenWeeklyState();
}

class _CalendarScreenWeeklyState extends State<CalendarScreenWeekly> {
  var lEvents;
