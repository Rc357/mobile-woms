...
class CalendarScreenDailySched extends StatefulWidget {
  @override
  _CalendarScreenDailySchedState createState() =>
      _CalendarScreenDailySchedState();
}

class _CalendarScreenDailySchedState extends State<CalendarScreenDailySched> {
  var lEvents;
  ...
  List<Appointment> getAppointment(var allEvents) {
    ...
    for (int i = 0; i < allEvents.length; i++) {
      ...
      lAppointment.add(Appointment(
          ...
          subject: allEvents[i].scheduleShifts,
